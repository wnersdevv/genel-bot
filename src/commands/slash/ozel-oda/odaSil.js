...
module.exports = {
    data: new SlashCommandBuilder().setName('oda-sil').setDescription('Özel odanızı siler.'),
    kategori: 'özelOda',
    ...
    async execute(client, interaction) {
        ...
        await interaction.reply({ embeds: [temelEmbed({ tip: 'basari', baslik: `${emojis.basari} Oda Siliniyor` })], flags: 64 });
        await OzelOda.deleteOne({ kanalId: kanal.id });
